...
public class Archive {
    ...
    public Location getLastRecord() {
        ...
        try {
            ...
            if (cursor.getCount() > 0) {
                point = getGeoPointFromCursor(cursor);
            }
            cursor.close();
    ...
    private Location getGeoPointFromCursor(Cursor cursor) {
    ...
    protected ArrayList<Location> fetchAll() {
        Cursor cursor = null;
        try {
            ...
            for (int i = 0; i < cursor.getCount(); i++) {
                ...
                geoPoints.add(getGeoPointFromCursor(cursor));
            }
